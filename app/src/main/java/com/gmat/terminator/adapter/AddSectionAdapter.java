...
/**
 * Created by Akanksha on 13-Jan-17.
 */
...
public class AddSectionAdapter extends RecyclerView.Adapter<AddSectionAdapter.ViewHolder>  {
    ...
    public AddSectionAdapter(Context inContext, ArrayList<String> inSectionList, ISectionClickListener listener) {
        mContext = inContext;
    ...
    @Override
    public void onBindViewHolder(AddSectionAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private RelativeLayout mSectionLyt;
        ...
        public ViewHolder(View view) {
            ...
            mSectionLyt = (RelativeLayout) view.findViewById(R.id.card_linear_lyt);
    ...
    @Override
    public AddSectionAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.section_info_lyt, parent, false);
        AddSectionAdapter.ViewHolder viewHolder = new AddSectionAdapter.ViewHolder(view);
        return viewHolder;
    }
